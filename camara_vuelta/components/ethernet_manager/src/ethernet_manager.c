...
esp_err_t ethman_deinit(esp_eth_handle_t eth_handle) {
  ESP_RETURN_ON_ERROR(
      esp_event_handler_unregister(IP_EVENT, IP_EVENT_ETH_LOST_IP, lost_ip_event_handler), TAG,
      "Couldn't unregister the IP lost handler");
  ESP_RETURN_ON_ERROR(
      esp_event_handler_unregister(IP_EVENT, IP_EVENT_ETH_GOT_IP, got_ip_event_handler), TAG,
      "Couldn't unregister the IP obtained handler");
  ESP_RETURN_ON_ERROR(esp_eth_stop(eth_handle), TAG, "Couldn't stop the ethernet driver");
  ESP_RETURN_ON_ERROR(esp_netif_deinit(), TAG, "Couldn't deinitialize netif");
